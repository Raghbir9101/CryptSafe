        ...
        <main className="container mx-auto px-6 py-20">
          ...
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              CryptSafe represents the next generation of secure data
              management, combining enterprise-grade encryption with intelligent
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                In an era where data breaches and unauthorized access threaten
                organizations daily, CryptSafe provides a comprehensive solution
                that doesn't compromise on security or usability.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                We believe that robust security should be accessible to
                organizations of all sizes, which is why we've built CryptSafe
                with an admin-first architecture that puts control back in the
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="text-center p-6">
                ...
                <p className="text-sm text-gray-600">
                  Lightning-fast access controls
                </p>
              </Card>
              <Card className="text-center p-6">
          ...
          <div className="mb-20">
            ...
            <p className="text-xl text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              CryptSafe combines multiple layers of security with intuitive
              management tools
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Location and IP-based access controls with real-time validation",
                },
                {
                  icon: Clock,
                  title: "Temporal Controls",
                  description:
                    "Time-based access windows with timezone awareness",
                },
                {
                  icon: Eye,
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Experience the power of next-generation data security with
              CryptSafe
            </p>
