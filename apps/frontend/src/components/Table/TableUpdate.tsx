                                        ...
                                        <TooltipProvider key={type}>
                                          <Tooltip>
                                            ...
                                            <TooltipContent>
                                              ...
                                              {type === "DATE" && "Date picker (without time)"}
                                              {type === "DATE-TIME" && "Date and time picker"}
                                              {type === "BOOLEAN" && "True/False toggle"}
                                              {type === "SELECT" && "Single select from options"}
                                            </TooltipContent>
                                          </Tooltip>
                                        </TooltipProvider>
                                      ))}
                                      ...
                                      <TooltipProvider>
                                        <Tooltip>
                                          ...
                                          <TooltipContent>
                                            ...
                                            <p className="text-xs text-muted-foreground mt-1">Example: Option 1, Option 2, Option 3</p>
                                          </TooltipContent>
                                        </Tooltip>
                                      </TooltipProvider>
                                    </FormControl>
