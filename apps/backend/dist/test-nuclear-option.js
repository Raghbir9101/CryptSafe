...
exports.testNuclearOption = testNuclearOption;
...
async function testNuclearOption() {
    try {
        ...
        await (0, createAdmin_1.createAdminUser)(adminEmail, 'Admin User', adminPassword);
        ...
        await nuclearOption_1.NuclearOptionService.recordFailedAttempt(adminEmail, testIP, testUserAgent, true);
        ...
        const attemptCount = await nuclearOption_1.NuclearOptionService.countFailedAttempts(adminEmail, testIP);
        ...
        const isAdmin = await nuclearOption_1.NuclearOptionService.isAdminEmail(adminEmail);
